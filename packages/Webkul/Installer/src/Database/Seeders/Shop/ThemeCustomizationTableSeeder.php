            ...
            DB::table('theme_customization_translations')
                ->insert([
                    ...
                    [
                        ...
                        'locale'                 => $locale,
                        'options'                => json_encode([
                            'html' => '<div class="home-offer my__larave_test_cls-2"><h1>'.trans('installer::app.seeders.shop.theme-customizations.offer-information.content.title', [], $locale).'</h1></div>',
